...
runrsa 2048 blockingCpu ; sleep 20
...
do
    ...
    checkprocess ; cal_perf rsaserverfull_$mod ; sleep 20
    cat b >> blockingCpu ; sed -i "s/%idle/rsaSE2048/g" blockingCpu
done

runrsa 3072 blockingCpu ; sleep 20
...
do
    ...
    checkprocess ; cal_perf recdes_$pkt $pkt ; sleep 20 ; cat b >> blockingCpu ; sed -i "s/%idle/recdes_$pkt/g" blockingCpu

    echo "recaes128_$pkt"
    printf "N\nB\n$thread\n$time\nG\n0\n128\n$pkt\nX" | ./pkpspeed -s crypto_user -p user123 >> $logdir/recaes128_$pkt&
    checkprocess ; cal_perf recaes128_$pkt $pkt ; sleep 20 ; cat b >> blockingCpu ; sed -i "s/%idle/recaes128_$pkt/g" blockingCpu

    echo "recaes256_$pkt"
    printf "N\nB\n$thread\n$time\nG\n0\n256\n$pkt\nX" | ./pkpspeed -s crypto_user -p user123 >> $logdir/recaes256_$pkt&
    checkprocess ; cal_perf recaes256_$pkt $pkt ; sleep 20 ; cat b >> blockingCpu ; sed -i "s/%idle/recaes256_$pkt/g" blockingCpu

    echo "recaesgcm128_$pkt"
    printf "N\nB\n$thread\n$time\nG\n2\n128\n$pkt\nX" | ./pkpspeed -s crypto_user -p user123 >> $logdir/recaesgcm128_$pkt&
    checkprocess ; cal_perf recaesgcm128_$pkt $pkt ; sleep 20 ; cat b >> blockingCpu ; sed -i "s/%idle/recaesgcm128_$pkt/g" blockingCpu

    echo "recaesgcm256_$pkt"
    printf "N\nB\n$thread\n$time\nG\n2\n256\n$pkt\nX" | ./pkpspeed -s crypto_user -p user123 >> $logdir/recaesgcm256_$pkt&
    checkprocess ; cal_perf recaesgcm256_$pkt $pkt ; sleep 20 ; cat b >> blockingCpu ; sed -i "s/%idle/recaesgcm256_$pkt/g" blockingCpu

    echo "des_$pkt"
    printf "N\nB\n$thread\n$time\nC\n$pkt\nX" | ./pkpspeed -s crypto_user -p user123 >> $logdir/des_$pkt&
    checkprocess ; cal_perf des_$pkt $pkt ; sleep 20 ; cat b >> blockingCpu ; sed -i "s/%idle/des_$pkt/g" blockingCpu

    echo "aes128_$pkt"
    printf "N\nB\n$thread\n$time\nD\n128\n$pkt\nX" | ./pkpspeed -s crypto_user -p user123 >> $logdir/aes128_$pkt&
    checkprocess ; cal_perf aes128_$pkt $pkt ; sleep 20 ; cat b >> blockingCpu ; sed -i "s/%idle/aes128_$pkt/g" blockingCpu

    echo "aes192_$pkt"
    printf "N\nB\n$thread\n$time\nD\n192\n$pkt\nX" | ./pkpspeed -s crypto_user -p user123 >> $logdir/aes192_$pkt&
    checkprocess ; cal_perf aes192_$pkt $pkt ; sleep 20 ; cat b >> blockingCpu ; sed -i "s/%idle/aes192_$pkt/g" blockingCpu

    echo "aes256_$pkt"
    printf "N\nB\n$thread\n$time\nD\n256\n$pkt\nX" | ./pkpspeed -s crypto_user -p user123 >> $logdir/aes256_$pkt&
    checkprocess ; cal_perf aes256_$pkt $pkt ; sleep 20 ; cat b >> blockingCpu ; sed -i "s/%idle/aes256_$pkt/g" blockingCpu

done

echo "Fips Random"
printf "N\nB\n$thread\n$time\nH\nX" | ./pkpspeed -s crypto_user -p user123 >> $logdir/rsafips&
checkprocess ; cal_perf rsafips; sleep 20 ; cat b >> blockingCpu ; sed -i "s/%idle/fipsrandom/g" blockingCpu
echo "ECDHFull P256"
printf "N\nB\n$thread\n$time\nJ\nP256\nX" | ./pkpspeed -s crypto_user -p user123 >> $logdir/rsap256&
checkprocess ; cal_perf rsap256 ; sleep 20 ; cat b >> blockingCpu ; sed -i "s/%idle/eccp256/g" blockingCpu
echo "ECDHFull P384"
printf "N\nB\n$thread\n$time\nJ\nP384\nX" | ./pkpspeed -s crypto_user -p user123 >> $logdir/rsap384&
checkprocess ; cal_perf rsap384 ; sleep 20 ; cat b >> blockingCpu ; sed -i "s/%idle/eccp384/g" blockingCpu
...
runrsa 2048 nonblockingCpu ; sleep 20
runrsa 3072 nonblockingCpu ; sleep 20
...
do
    echo "des_$pkt"
    printf "N\nB\n$thread\n$time\nC\n$pkt\nX" | ./pkpspeed -s crypto_user -p user123 >> $logdir/des_$pkt&
    checkprocess ; cal_perf des_$pkt $pkt ; sleep 20 ; cat b >> nonblockingCpu ; sed -i "s/%idle/des_$pkt/g" nonblockingCpu

    echo "aes128_$pkt"
    printf "N\nB\n$thread\n$time\nD\n128\n$pkt\nX" | ./pkpspeed -s crypto_user -p user123 >> $logdir/aes128_$pkt&
    checkprocess ; cal_perf aes128_$pkt $pkt ; sleep 20 ; cat b >> nonblockingCpu ; sed -i "s/%idle/aes128_$pkt/g" nonblockingCpu

    echo "aes256_$pkt"
    printf "N\nB\n$thread\n$time\nD\n256\n$pkt\nX" | ./pkpspeed -s crypto_user -p user123 >> $logdir/aes256_$pkt&
    checkprocess ; cal_perf aes256_$pkt $pkt ; sleep 20 ; cat b >> nonblockingCpu ; sed -i "s/%idle/aes256_$pkt/g" nonblockingCpu
done
